...
export default function ReportMailConfigEditor({ value, onChange }: Props) {
            ...
            <div key={fieldName} className="rounded border border-slate-200 p-4 transition-colors dark:border-slate-700">
              ...
              <div className="mt-3 grid gap-3 lg:grid-cols-2">
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-300">Default</span>
                  {isTextArea ? (
                    <textarea
                ...
                <label className="block">
                  <span className="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-300">Mandatory</span>
                  {isTextArea ? (
                    <textarea
                      className={inputBaseClass}
